...
from model.layers import MultiSpectralAttentionLayer
...
def fcanet34(bit=None, pretrained=False):
    """Constructs a FcaNet-34 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(FcaBasicBlock, [3, 4, 6, 3], num_classes=1)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    model.fc = HashLayer(bit)
    return model


def fcanet50(bit=None, pretrained=False):
    """Constructs a FcaNet-50 model.
    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = ResNet(FcaBottleneck, [3, 4, 6, 3], num_classes=1)
    model.avgpool = nn.AdaptiveAvgPool2d(1)
    model.fc = HashLayer(bit)
    return model
...
model = fcanet50(bit=10,pretrained=False)
